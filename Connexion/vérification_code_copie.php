...
<body onload="generate()">
     <header>
        ...
        <div class="menu">
        <ul>
          <a href="http://" target="_blank" rel="noopener noreferrer">  <li><i class="fa-sharp fa-solid fa-house"></i></li></a>
          <a href="http://" target="_blank" rel="noopener noreferrer"> <li><i class="fa-sharp fa-solid fa-cart-shopping"></i></li></a>
          <a href="http://" target="_blank" rel="noopener noreferrer"> <li><i class="fa-sharp fa-solid fa-envelope"></i></li></a>
          <a href="connexion.php" target="_blank" rel="noopener noreferrer"> <li><i class="fa-sharp fa-solid fa-user"></i></li></a>
        </ul>
        </div>
    </header>
