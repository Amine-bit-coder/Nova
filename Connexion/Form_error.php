<?PHP
session_start();
if($_SESSION["erreur1"]){$msg1="Mot de pass min. 8 caracteres";}
else{$msg1="";}
if($_SESSION["erreur2"]){$msg2="Mot de pass incoherent";}
else{$msg2="";}
if($_SESSION["erreur3"]){$msg3="Captcha invalide";}
...
<?PHP   echo      '<input type="email" id="email" name="email" required onBlur="verif_email()" class="input" value="'.$_SESSION["email"].'" >';   ?> 
        </p>
        <p>
